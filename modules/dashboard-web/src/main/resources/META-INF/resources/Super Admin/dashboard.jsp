...
<div class="dashboard-container">
    ...
    <c:if test="${userRole == 'SUPER_ADMIN' || userRole == 'ADMIN'}">
        <div class="admin-section">
            ...
            <div class="employee-management">
                ...
                <c:if test="${not empty employees}">
                            ...
                            <c:forEach var="employee" items="${employees}">
                                <c:if test="${employee.role == 'ADMIN'}">
                                    <tr>
                                        ...
                                        <td><fmt:formatDate value="${employee.lastLogin}" pattern="dd/MM/yyyy HH:mm"/></td>
                                    </tr>
                                </c:if>
                            </c:forEach>
                            </tbody>
                    ...
                    <h4 style="margin-top:30px;"><i class="fas fa-users"></i> Liste des Employés</h4>
                    <c:if test="${not empty employees}">
                        <table class="employee-table">
                            <thead>
                            <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <portlet:actionURL name="deleteAdmin" var="deleteAdminURL">
                                                <portlet:param name="idUtilisateur" value="${employee.idUtilisateur}" />
                                            </portlet:actionURL>
                                            <form method="post" action="${deleteAdminURL}" style="margin:0;">
                                                <button type="submit" class="update-btn"
                                                        onclick="return confirm('Supprimer ${employee.email}?')">Supprimer</button>
                                            </form>
                                        </td>
                                    </tr>
                                </c:if>
        ...
        <form method="post" action="${addAdminURL}" style="margin-top:15px;">
            ...
            <button type="submit" class="update-btn">
                <i class="fas fa-user-plus"></i> Ajouter Admin
            </button>
        </form>
    ...
    <c:if test="${userRole == 'SUPER_ADMIN'}">
        <div class="admin-section" style="margin-top:30px; background:#eaf4ff; border-left:4px solid #007bff;">
            <h3><i class="fas fa-eye"></i> Super Admin - Global Visibility</h3>
            ...
            <div class="dashboard-cards">
                ...
                <div class="card">
                    ...
                    <p>Consulter l’historique des connexions, actions et erreurs système.</p>
                    <a href="<portlet:renderURL><portlet:param name="mvcPath" value="/Super Admin/logs.jsp"/></portlet:renderURL>"
                       class="update-btn">Voir Logs</a>
                </div>
                ...
                <div class="card">
                    ...
                    <a href="<portlet:renderURL><portlet:param name="mvcPath" value="/Super Admin/stats.jsp"/></portlet:renderURL>"
                       class="update-btn">Voir Statistiques</a>
                </div>
                ...
                <div class="card">
                    ...
                    <a href="<portlet:renderURL><portlet:param name="mvcPath" value="/Super Admin/security.jsp"/></portlet:renderURL>"
                       class="update-btn">Paramètres Sécurité</a>
                </div>
            </div>
        </div>
    </c:if>
