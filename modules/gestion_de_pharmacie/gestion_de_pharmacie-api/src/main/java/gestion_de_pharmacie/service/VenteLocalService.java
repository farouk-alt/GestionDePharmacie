...
/**
 * Provides the local service interface for Vente. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Farouk
 * @see VenteLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface VenteLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>gestion_de_pharmacie.service.impl.VenteLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the vente local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link VenteLocalServiceUtil} if injection and service tracking are not available.
	 */
