...
/**
 * Provides the local service utility for MouvementStock. This utility wraps
 * <code>gestion_de_pharmacie.service.impl.MouvementStockLocalServiceImpl</code> and
 ...
 * @generated
 */
public class MouvementStockLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>gestion_de_pharmacie.service.impl.MouvementStockLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static MouvementStock addMouvementStock(
		MouvementStock mouvementStock) {

		return getService().addMouvementStock(mouvementStock);
	}
	 ...
	 */
	public static MouvementStock createMouvementStock(long idMouvement) {
		return getService().createMouvementStock(idMouvement);
	}
	 ...
	 */
	public static MouvementStock deleteMouvementStock(long idMouvement)
		throws PortalException {

		return getService().deleteMouvementStock(idMouvement);
	}
	 ...
	 * @return the mouvement stock that was removed
	 */
	public static MouvementStock deleteMouvementStock(
		MouvementStock mouvementStock) {

		return getService().deleteMouvementStock(mouvementStock);
	}
	...
	public static MouvementStock fetchMouvementStock(long idMouvement) {
		return getService().fetchMouvementStock(idMouvement);
	}
	 ...
	 * @throws PortalException if a mouvement stock with the primary key could not be found
	 */
	public static MouvementStock getMouvementStock(long idMouvement)
		throws PortalException {

		return getService().getMouvementStock(idMouvement);
	}
	 ...
	 */
	public static List<MouvementStock> getMouvementStocks(int start, int end) {
		return getService().getMouvementStocks(start, end);
	}
	 ...
	 */
	public static int getMouvementStocksCount() {
		return getService().getMouvementStocksCount();
	}
	 ...
	 */
	public static MouvementStock updateMouvementStock(
		MouvementStock mouvementStock) {

		return getService().updateMouvementStock(mouvementStock);
	}

	public static MouvementStockLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<MouvementStockLocalService> _serviceSnapshot =
		new Snapshot<>(
			MouvementStockLocalServiceUtil.class,
			MouvementStockLocalService.class);
