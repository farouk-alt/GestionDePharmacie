...
/**
 * The persistence interface for the fournisseur service.
 *
 * <p>
 ...
 */
@ProviderType
public interface FournisseurPersistence extends BasePersistence<Fournisseur> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FournisseurUtil} to access the fournisseur persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(java.util.List<Fournisseur> fournisseurs);
	 ...
	 */
	public java.util.List<Fournisseur> findAll();
	 ...
	 */
	public java.util.List<Fournisseur> findAll(int start, int end);
	...
	public java.util.List<Fournisseur> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Fournisseur>
			orderByComparator);
