...
public interface StockService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>gestion_de_pharmacie.service.impl.StockServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the stock remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link StockServiceUtil} if injection and service tracking are not available.
	 */
