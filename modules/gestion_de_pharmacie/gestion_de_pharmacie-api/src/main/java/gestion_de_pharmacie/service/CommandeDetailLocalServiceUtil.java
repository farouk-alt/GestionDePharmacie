...
/**
 * Provides the local service utility for CommandeDetail. This utility wraps
 * <code>gestion_de_pharmacie.service.impl.CommandeDetailLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CommandeDetailLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>gestion_de_pharmacie.service.impl.CommandeDetailLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static CommandeDetail addCommandeDetail(
	 ...
	 */
	public static CommandeDetail createCommandeDetail(long idDetail) {
		return getService().createCommandeDetail(idDetail);
	}
	 ...
	 */
	public static CommandeDetail deleteCommandeDetail(
		CommandeDetail commandeDetail) {

		return getService().deleteCommandeDetail(commandeDetail);
	}
	 ...
	 */
	public static CommandeDetail deleteCommandeDetail(long idDetail)
		throws PortalException {

		return getService().deleteCommandeDetail(idDetail);
	}
	...
	public static CommandeDetail fetchCommandeDetail(long idDetail) {
	 ...
	 * @throws PortalException if a commande detail with the primary key could not be found
	 */
	public static CommandeDetail getCommandeDetail(long idDetail)
		throws PortalException {

		return getService().getCommandeDetail(idDetail);
	}
	 ...
	 */
	public static List<CommandeDetail> getCommandeDetails(int start, int end) {
		return getService().getCommandeDetails(start, end);
	}
	 ...
	 */
	public static int getCommandeDetailsCount() {
		return getService().getCommandeDetailsCount();
	}
	 ...
	 */
	public static CommandeDetail updateCommandeDetail(
		CommandeDetail commandeDetail) {

		return getService().updateCommandeDetail(commandeDetail);
	}

	public static CommandeDetailLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<CommandeDetailLocalService> _serviceSnapshot =
		new Snapshot<>(
			CommandeDetailLocalServiceUtil.class,
			CommandeDetailLocalService.class);
